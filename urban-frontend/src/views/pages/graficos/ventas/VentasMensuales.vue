...
import { getResumenVentas } from '@/http/graficos/ventas/resumen-ventas';
...
const fetchData = async () => {
    clearChart();
    try {
        let stats = await getResumenVentas({ fecha_desde: initialDate, fecha_hasta: finalDate });
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card bg-blue-500 shadow-4 mb-1 p-3">
                <!-- <h4 class="text-center font-bold text-white mb-0 py-1">Ventas Mensuales</h4> -->
                <h5 class="logo-title text-2xl text-center text-white">Ventas Mensuales</h5>
            </div>
